...
class DbHelper extends SQLiteOpenHelper {
    ...
    public static final String LECTURER_NAME_KEY = "LECTURER_NAME";
    ...
    private static final String CREATE_CLASS_TABLE =
            "CREATE TABLE " + CLASS_TABLE_NAME + "(" +
                    ...
                    LECTURER_NAME_KEY + "TEXT NOT NULL," +
                    "UNIQUE (" + CLASS_NAME_KEY + "," + SUBJECT_NAME_KEY + "," + LECTURER_NAME_KEY + ")"+
                    ");";
    ...
    private static final String STUDENT_TIME_KEY = "TIME";
    ...
    long addClass(String className, String subjectName, String lecturerName){
        SQLiteDatabase database = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(CLASS_NAME_KEY,className);
        values.put(SUBJECT_NAME_KEY,subjectName);
        values.put(LECTURER_NAME_KEY,lecturerName);
